...
type UsersGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('#dashboard/controllers/users_controller').default['index'],
    false
  >
}
type UsersPost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#dashboard/validators'))['createUserValidator']>
  >
  response: MakeTuyauResponse<
    import('#dashboard/controllers/users_controller').default['store'],
    true
  >
}
type UsersIdPutPatch = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#dashboard/validators'))['editUserValidator']>
  >
  response: MakeTuyauResponse<
    import('#dashboard/controllers/users_controller').default['update'],
    true
  >
}
type UsersIdDelete = {
  request: unknown
  response: MakeTuyauResponse<
    import('#dashboard/controllers/users_controller').default['destroy'],
    false
  >
}
type UsersInvitePost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#dashboard/validators'))['inviteUserValidator']>
  >
  response: MakeTuyauResponse<
    import('#dashboard/controllers/invite_controller').default['handle'],
    true
  >
}
type UsersImpersonateIdPost = {
  request: unknown
  response: MakeTuyauResponse<
    import('#dashboard/controllers/impersonates_controller').default['store'],
    false
  >
}
type SettingsProfilePut = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#dashboard/validators'))['updateProfileValidator']>
  >
  response: MakeTuyauResponse<
...
type ApiTokensPost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#dashboard/validators'))['createTokenValidator']>
  >
  response: MakeTuyauResponse<
...
type SettingsPasswordPut = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('#dashboard/validators'))['updatePasswordValidator']>
  >
  response: MakeTuyauResponse<
...
type DashboardGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/dashboard/controllers/dashboard_controller.ts').default['handle'],
    false
  >
}

...
export default class BaseModelDto extends BaseDto {
     ...
     */
    static fromPaginator<Model, Dto extends BaseDto>(this: StaticDto<Model, Dto>, paginator: Model extends LucidRow ? ModelPaginatorContract<Model> : SimplePaginatorContract<Model>, range?: SimplePaginatorDtoMetaRange): SimplePaginatorDto<Model, Dto>;
}

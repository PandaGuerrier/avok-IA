 ...
 */
export type NarrowAbilitiesForAUser<User, Abilities extends Record<string, BouncerAbility<any>> | undefined> = {
 ...
 * arguments.
 */
export type BouncerAuthorizer<User> = (user: User, ...args: any[]) => AuthorizerResponse | Promise<AuthorizerResponse>;
/**

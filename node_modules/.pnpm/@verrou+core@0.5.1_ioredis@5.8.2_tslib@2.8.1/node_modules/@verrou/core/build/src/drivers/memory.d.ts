 ...
 */
declare function memoryStore(): {
    factory: () => MemoryStore;
};
declare class MemoryStore implements LockStore {
    #private;
    /**
     * For a given key, get or create a new lock
     */
    getOrCreateForKey(key: string, owner: string): MemoryLockEntry;
    /**

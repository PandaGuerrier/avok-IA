import { LockStore } from '../types/main.js';
import { D as DynamoDbOptions } from '../../drivers-ClN4eGOp.js';
 ...
 */
declare function dynamodbStore(config: DynamoDbOptions): {
    factory: () => DynamoDBStore;
};
declare class DynamoDBStore implements LockStore {
    #private;
...
export { DynamoDBStore, dynamodbStore };

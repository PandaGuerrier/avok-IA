 ...
 */
type MakeNonSerializedTuyauResponse<T extends (...args: any) => any, HasSchema extends boolean = false> = ConvertReturnTypeToRecordStatusResponse<Awaited<ReturnType<T>>> & (HasSchema extends true ? {
    422: {
        errors: {
            message: string;
            rule: string;

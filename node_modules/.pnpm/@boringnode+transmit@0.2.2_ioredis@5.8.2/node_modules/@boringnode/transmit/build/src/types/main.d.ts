...
} | string | number | boolean | null | Broadcastable[];
...
export type AccessCallback<Context extends unknown, Params extends Record<string, string>> = (context: Context, params: Params) => Promise<boolean> | boolean;
